...
#plotting for residuals (independence)
par(mfrow= c(2,3))
...
# Histograms for normality with bell curve
par(mfrow = c(2, 3))

hist(residuals(model1), freq = FALSE, breaks = 10, col = "red", xlab = "Residuals", ylab = "Density", main = "Anti Social Behaviour", cex.lab = 1.2)
curve(dnorm(x, mean = mean(residuals(model1)), sd = sd(residuals(model1))), add = TRUE, col = "black", lwd = 2)

hist(residuals(model2), freq = FALSE, breaks = 10, col = "blue", xlab = "Residuals", ylab = "Density", main = "Burglary", cex.lab = 1.2)
curve(dnorm(x, mean = mean(residuals(model2)), sd = sd(residuals(model2))), add = TRUE, col = "black", lwd = 2)

hist(residuals(model3), freq = FALSE, breaks = 10, col = "red", xlab = "Residuals", ylab = "Density", main = "Robbery", cex.lab = 1.2)
curve(dnorm(x, mean = mean(residuals(model3)), sd = sd(residuals(model3))), add = TRUE, col = "black", lwd = 2)

hist(residuals(model4), freq = FALSE, breaks = 10, col = "green", xlab = "Residuals", ylab = "Density", main = "Vehicle Crimes", cex.lab = 1.2)
curve(dnorm(x, mean = mean(residuals(model4)), sd = sd(residuals(model4))), add = TRUE, col = "black", lwd = 2)

hist(residuals(model5), freq = FALSE, breaks = 10, col = "red", xlab = "Residuals", ylab = "Density", main = "Violent Crimes", cex.lab = 1.2)
curve(dnorm(x, mean = mean(residuals(model5)), sd = sd(residuals(model5))), add = TRUE, col = "black", lwd = 2)

hist(residuals(model6), freq = FALSE, breaks = 10, col = "orange", xlab = "Residuals", ylab = "Density", main = "Shoplifting", cex.lab = 1.2)
curve(dnorm(x, mean = mean(residuals(model6)), sd = sd(residuals(model6))), add = TRUE, col = "black", lwd = 2)

hist(residuals(model7), freq = FALSE, breaks = 10, col = "red", xlab = "Residuals", ylab = "Density", main = "Criminal Damage and Arson", cex.lab = 1.2)
curve(dnorm(x, mean = mean(residuals(model7)), sd = sd(residuals(model7))), add = TRUE, col = "black", lwd = 2)

hist(residuals(model8), freq = FALSE, breaks = 10, col = "yellow", xlab = "Residuals", ylab = "Density", main = "Other Theft", cex.lab = 1.2)
curve(dnorm(x, mean = mean(residuals(model8)), sd = sd(residuals(model8))), add = TRUE, col = "black", lwd = 2)

hist(residuals(model9), freq = FALSE, breaks = 10, col = "green", xlab = "Residuals", ylab = "Density", main = "Drugs", cex.lab = 1.2)
curve(dnorm(x, mean = mean(residuals(model9)), sd = sd(residuals(model9))), add = TRUE, col = "black", lwd = 2)

hist(residuals(model10), freq = FALSE, breaks = 10, col = "blue", xlab = "Residuals", ylab = "Density", main = "Other Crimes", cex.lab = 1.2)
curve(dnorm(x, mean = mean(residuals(model10)), sd = sd(residuals(model10))), add = TRUE, col = "black", lwd = 2)

hist(residuals(model11), freq = FALSE, breaks = 10, col = "red", xlab = "Residuals", ylab = "Density", main = "Bike Theft", cex.lab = 1.2)
curve(dnorm(x, mean = mean(residuals(model11)), sd = sd(residuals(model11))), add = TRUE, col = "black", lwd = 2)

hist(residuals(model12), freq = FALSE, breaks = 10, col = "blue", xlab = "Residuals", ylab = "Density", main = "Possession of Weapons", cex.lab = 1.2)
curve(dnorm(x, mean = mean(residuals(model12)), sd = sd(residuals(model12))), add = TRUE, col = "black", lwd = 2)

hist(residuals(model13), freq = FALSE, breaks = 10, col = "red", xlab = "Residuals", ylab = "Density", main = "Public Order", cex.lab = 1.2)
curve(dnorm(x, mean = mean(residuals(model13)), sd = sd(residuals(model13))), add = TRUE, col = "black", lwd = 2)

hist(residuals(model14), freq = FALSE, breaks = 10, col = "green", xlab = "Residuals", ylab = "Density", main = "Theft From the Person", cex.lab = 1.2)
curve(dnorm(x, mean = mean(residuals(model14)), sd = sd(residuals(model14))), add = TRUE, col = "black", lwd = 2)
